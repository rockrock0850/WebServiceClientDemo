...
public class CalculatorLocator extends org.apache.axis.client.Service implements com.web.service.client.demo.calculator.Calculator {
    ...
    public com.web.service.client.demo.calculator.CalculatorSoap getCalculatorSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.web.service.client.demo.calculator.CalculatorSoapStub _stub = new com.web.service.client.demo.calculator.CalculatorSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.web.service.client.demo.calculator.CalculatorSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.web.service.client.demo.calculator.CalculatorSoapStub _stub = new com.web.service.client.demo.calculator.CalculatorSoapStub(new java.net.URL(CalculatorSoap_address), this);
                _stub.setPortName(getCalculatorSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://calculator.demo.client.service.web.com", "Calculator");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://calculator.demo.client.service.web.com", "CalculatorSoap"));
        }
