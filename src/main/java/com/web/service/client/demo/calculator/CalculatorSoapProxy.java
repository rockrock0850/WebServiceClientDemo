...
public class CalculatorSoapProxy implements com.web.service.client.demo.calculator.CalculatorSoap {
  private String _endpoint = null;
  private com.web.service.client.demo.calculator.CalculatorSoap calculatorSoap = null;
  ...
  private void _initCalculatorSoapProxy() {
    try {
      calculatorSoap = (new com.web.service.client.demo.calculator.CalculatorLocator()).getCalculatorSoap();
  ...
  public com.web.service.client.demo.calculator.CalculatorSoap getCalculatorSoap() {
    if (calculatorSoap == null)
      _initCalculatorSoapProxy();
